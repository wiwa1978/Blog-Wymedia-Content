...
slug: microsoft-foundry/part8-from-notebook-to-production
artifactPath: "Microsoft Foundry/part8-from-notebook-to-production"
tags: []
series: {"slug":"microsoft-foundry","title":"Microsoft Foundry","part":8}
publishAt: "2026-07-22T15:55:00.000Z"
---
# Microsoft Foundry SDK: Part 8 – From Notebook to Production
...
This final post bridges the gap from local notebooks and dev projects to **production-grade agent operations**. You'll learn agent versioning strategies, blue-green deployments, environment promotion patterns, and how to instrument your pipeline with the observability and evaluation techniques from part 4.

## Prerequisites

- Foundry project with `azure-ai-projects` >= 2.3.0
- A deployed Hosted agent (from part 6)
...
# Step 3: Run evaluations in staging (part 4 technique)
print(f"→ Running evaluations on staging version {staging_version}...")
# (Use techniques from part 4 here)
...
Instrument your rollout with telemetry from part 4. Use **spans** to track which agent version is handling each request:

```python
from azure.monitor.opentelemetry import configure_azure_monitor
from opentelemetry import trace

# Configure OpenTelemetry (from part 4)
...
# Define RAI (Responsible AI) guardrails (from part 4)
...
The eight-part series has taken you from "Hello Agent" to production-grade orchestration:
...
5. **Part 5** – Safety & Insights: Tracing, evaluations, continuous eval, guardrails
6. **Part 6** – Scale: Multi-agent orchestration via A2A, specialist coordination
7. **Part 7** – Infrastructure: Hosted agents, versioning, deployment automation
8. **Part 8** – Operations: Rollout strategies, environment promotion, production guardrails
...
**[part8_from_notebook_to_production.py](code/part8_from_notebook_to_production.py)**

Run it locally:
```bash
python part8_from_notebook_to_production.py
```
