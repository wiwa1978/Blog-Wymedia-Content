...
slug: microsoft-foundry/part7-from-notebook-to-production
artifactPath: "Microsoft Foundry/part7-from-notebook-to-production"
tags: []
series: {"slug":"microsoft-foundry","title":"Microsoft Foundry","part":7}
publishAt: "2026-07-22T15:55:00.000Z"
---
# Microsoft Foundry SDK: Part 7 – From Notebook to Production
...
The seven-part series has taken you from "Hello Agent" to production-grade orchestration:
...
4. **Part 4** – Safety & Insights: Tracing, evaluations, continuous eval, guardrails
5. **Part 5** – Scale: Multi-agent orchestration via A2A, specialist coordination
6. **Part 6** – Infrastructure: Hosted agents, versioning, deployment automation
7. **Part 7** – Operations: Rollout strategies, environment promotion, production guardrails
...
**[part7_from_notebook_to_production.py](code/part7_from_notebook_to_production.py)**

Run it locally:
```bash
python part7_from_notebook_to_production.py
```
