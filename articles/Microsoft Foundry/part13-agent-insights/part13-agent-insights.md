...
articleId: 4adf0b47-7184-402e-ab25-b44d547d38f5
...
publishAt: "2026-09-22T18:01:00.000Z"
---
...
Run the commands from the `part13-agent-insights` directory. If you start in the repository root:

```powershell
Set-Location ".\articles\Microsoft Foundry\part13-agent-insights"
```
