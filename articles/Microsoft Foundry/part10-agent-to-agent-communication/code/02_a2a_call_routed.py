"""
Routed A2A call using Foundry agent with A2ATool reference.

NOTE: This approach requires pre-configured A2A connections in Foundry.
...
For most use cases, the direct A2A approach (01_a2a_call_direct.py) is simpler
...
4. The A2ATool uses a pre-configured Foundry connection to reach the remote agent
"""
