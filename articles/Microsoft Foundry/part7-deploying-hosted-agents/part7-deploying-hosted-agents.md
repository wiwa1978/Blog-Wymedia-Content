...
slug: microsoft-foundry/part7-deploying-hosted-agents
artifactPath: "Microsoft Foundry/part7-deploying-hosted-agents"
tags: []
series: {"slug":"microsoft-foundry","title":"Microsoft Foundry","part":7}
publishAt: "2026-07-20T09:04:00.000Z"
---
# Microsoft Foundry SDK: Part 7 – Deploying Hosted Agents
...
# Use app_insights_conn to initialize OpenTelemetry (part 4)
```
...
Next up: **Part 8** – From Notebook to Production—versioning strategies, multi-environment promotion, and guardrails for shipping.
...
**[part7_deploying_hosted_agents.py](code/part7_deploying_hosted_agents.py)**

Run it locally:
```bash
python part7_deploying_hosted_agents.py
```
