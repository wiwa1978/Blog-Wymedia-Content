---
title: "Microsoft Foundry SDK: Part 8 – Multi-Agent Orchestration"
...
slug: microsoft-foundry/part8-multi-agent-orchestration
...
Next up: **Part 9** – Deploying agents to production with versioning, blue-green rollouts, and environment management.
...
**[part8_multi_agent_orchestration.py](code/part8_multi_agent_orchestration.py)**

Run it locally:
```bash
python part8_multi_agent_orchestration.py
```
