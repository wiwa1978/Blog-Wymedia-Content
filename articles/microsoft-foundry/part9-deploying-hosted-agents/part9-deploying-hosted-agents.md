...
Next up: **Part 10** – From Notebook to Production—versioning strategies, multi-environment promotion, and guardrails for shipping.
...
**[part9_deploying_hosted_agents.py](code/part9_deploying_hosted_agents.py)**

Run it locally:
```bash
python part9_deploying_hosted_agents.py
```
