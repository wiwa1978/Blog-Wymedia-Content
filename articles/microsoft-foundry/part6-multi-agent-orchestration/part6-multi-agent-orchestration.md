...
slug: microsoft-foundry/part6-multi-agent-orchestration
artifactPath: "microsoft-foundry/part6-multi-agent-orchestration"
tags: []
series: {"slug":"microsoft-foundry","title":"Microsoft Foundry","part":6}
publishAt: "2026-07-13T16:02:00.000Z"
---
# Microsoft Foundry SDK: Part 6 – Multi-Agent Orchestration
...
Next up: **Part 7** – Deploying agents to production with versioning, blue-green rollouts, and environment management.
...
**[part6_multi_agent_orchestration.py](code/part6_multi_agent_orchestration.py)**

Run it locally:
```bash
python part6_multi_agent_orchestration.py
```
