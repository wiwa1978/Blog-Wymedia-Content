...
slug: microsoft-foundry/part5-multi-agent-orchestration
artifactPath: "microsoft-foundry/part5-multi-agent-orchestration"
tags: []
series: {"slug":"microsoft-foundry","title":"Microsoft Foundry","part":5}
publishAt: "2026-07-13T16:02:00.000Z"
---
# Microsoft Foundry SDK: Part 5 – Multi-Agent Orchestration
...
Next up: **Part 6** – Deploying agents to production with versioning, blue-green rollouts, and environment management.
...
**[part5_multi_agent_orchestration.py](code/part5_multi_agent_orchestration.py)**

Run it locally:
```bash
python part5_multi_agent_orchestration.py
```
