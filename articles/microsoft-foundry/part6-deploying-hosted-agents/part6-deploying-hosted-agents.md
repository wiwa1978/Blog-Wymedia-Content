...
slug: microsoft-foundry/part6-deploying-hosted-agents
artifactPath: "microsoft-foundry/part6-deploying-hosted-agents"
tags: []
series: {"slug":"microsoft-foundry","title":"Microsoft Foundry","part":6}
publishAt: "2026-07-20T09:04:00.000Z"
---
# Microsoft Foundry SDK: Part 6 – Deploying Hosted Agents
...
Next up: **Part 7** – From Notebook to Production—versioning strategies, multi-environment promotion, and guardrails for shipping.
...
**[part6_deploying_hosted_agents.py](code/part6_deploying_hosted_agents.py)**

Run it locally:
```bash
python part6_deploying_hosted_agents.py
```
