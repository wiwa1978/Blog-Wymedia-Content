...
slug: microsoft-foundry/part5-observability-evaluation-guardrails
artifactPath: "microsoft-foundry/part5-observability-evaluation-guardrails"
tags: []
series: {"slug":"microsoft-foundry","title":"Microsoft Foundry","part":5}
publishAt: "2026-07-06T18:01:00.000Z"
---
# Part 5 - Trust but verify: observability, evaluations, and guardrails in the Microsoft Foundry SDK
...
**[part5_observability_evaluation_guardrails.py](code/part5_observability_evaluation_guardrails.py)**

Run it locally:
```bash
python part5_observability_evaluation_guardrails.py
```
